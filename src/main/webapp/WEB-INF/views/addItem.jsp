...
<body>
	...
	<form class="form-addItem form-horizontal" action="./home.html" method="get" name="addItem" >
		...
		<div class="form-group">
			...
			<div class="col-sm-10">
			  <input type="password" class="form-control" id="inputEmail3" name="itemName"  placeholder="상품명">
			</div>
		</div>
		<div class="form-group">
